...
export default function HeroSection() {
  return (
    <section className="relative bg-[hsl(var(--primary-bg))] py-20 md:py-32 overflow-hidden transition-all duration-500" 
      style={{ 
      ...
      <div className="absolute inset-0 bg-gradient-to-r from-[hsl(var(--primary-bg))] via-[hsla(var(--primary-bg),0.95)] to-[hsl(var(--primary-bg))] before:bg-black/60 before:absolute before:inset-0 transition-opacity duration-500"></div>
